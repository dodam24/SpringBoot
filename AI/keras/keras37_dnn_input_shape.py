...
model = Sequential()
model.add(Dense(128, activation='relu', input_shape=(28, 28)))      # 행 무시하고 나머지가 input_shape이므로 (28, 28)
model.add(Dropout(0.3))
model.add(Dense(64, activation='relu'))
model.add(Dropout(0.3))
model.add(Dense(32, activation='relu'))
model.add(Flatten())                            # Dense 모델은 2차원 이상 가능 (Layer에서 Flatten 이용함으로써 다차원도 입력 가능)
...
313/313 [==============================] - 1s 2ms/step - loss: 0.0883 - acc: 0.9740
loss :  0.08834636211395264
