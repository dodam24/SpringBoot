...
#2. 모델 구성 (순차형)
model = Sequential()
model.add(Conv2D(64, (2,1), input_shape=(3, 3, 6)))
model.add(Flatten())
...
''' 걸린 시간 :  3268.2904090881348
3632/3632 [==============================] - 5s 1ms/step - loss: 8.5981 - accuracy: 0.1468
loss :  8.59809398651123
accuracy :  0.14678622782230377
y_pred(예측값) :  [6 6 6 1 6 6 6 6 1 4 1 1 6 6 6 6 6 6 6 6]
