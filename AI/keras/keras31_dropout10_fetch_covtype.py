...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1, save_best_only=True, 
                      ...
                      filepath = filepath + 'K31_fetch_covtype_' + 'd_' + date + '_' + 'e_v_' + filename)


model.fit(x_train, y_train, epochs=1000, batch_size=30, validation_split=0.2, verbose=1, callbacks=[es, mcp])

model.save(path + 'keras31_dropout_save_model_fetch_covtype.h5')
...
mse :  0.8213858008384705
mae :  0.5605762600898743
==============================
R2 :  0.5769707429184274
RMSE :  0.9063032322776936
============================== """