...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1, save_best_only=True, 
                      ...
                      filepath = filepath + 'K31_cancer_' + 'd_' + date + '_' + 'e_v_' + filename)


model.fit(x_train, y_train, epochs=1000, batch_size=15, validation_split=0.2, verbose=1, callbacks=[es, mcp])

model.save(path + 'keras31_dropout_save_model_cancer.h5')
...
mse :  0.029305562376976013
mae :  0.07409366220235825
==============================
R2 :  0.8663197323786279
RMSE :  0.17118867339888003
============================== """