...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1, save_best_only=True, 
                      ...
                      filepath = filepath + 'K31_digits_' + 'd_' + date + '_' + 'e_v_' + filename)


model.fit(x_train, y_train, epochs=1000, batch_size=15, validation_split=0.2, verbose=1, callbacks=[es, mcp])

model.save(path + 'keras31_dropout_save_model_digits.h5')
...
mse :  1.279398798942566
mae :  0.702090859413147
==============================
R2 :  0.838727307383032
RMSE :  1.1311051756548127
============================== """