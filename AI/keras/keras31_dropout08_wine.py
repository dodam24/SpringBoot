...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1, save_best_only=True, 
                      ...
                      filepath = filepath + 'K31_wine_' + 'd_' + date + '_' + 'e_v_' + filename)


model.fit(x_train, y_train, epochs=1000, batch_size=15, validation_split=0.2, verbose=1, callbacks=[es, mcp])

model.save(path+'keras31_dropout_save_model_wine.h5')
...
mse :  0.10460035502910614
mae :  0.2813306152820587
==============================
R2 :  0.8204476230502395
RMSE :  0.3234197629293764
============================== """