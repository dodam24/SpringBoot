...
public class StringMain {
	...
	public static void main(String[] args) {
		...
		/*
		 문자열은 편집이 안 된다. -> 메모리에 4번의 생성이 일어난다
		 JVM에 의해서 삭제 시, Garbage Collector로 보낸다
		 Garbage Collector가 실행되면 컴퓨터는 멈춘다
		 */
		
		System.out.println("문자열 크기 = " + e.length()); //배열.length
		...
		System.out.println("문자열 검색=" + e.indexOf("개바부")); //-1 (없는 문자열은 -1 반환)
		
		System.out.println("문자열 치환 = " + e.replace("날짜", "일자")); //오늘 일자는 2023210
